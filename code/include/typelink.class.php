...
class TypeLink
{
    ...
    {
        $this->dsql->SetQuery("SELECT id,reid,typename,typedir,isdefault,description,ispart,defaultname,namerule2,moresite,siteurl,sitepath FROM #@__arctype WHERE id='".$id."'");
